...
bool Cari(simpul DL, char elemen);
    ...
    do {
        ...
        switch (menu) {
            ...
            case 8:
                ...
                cin >> huruf;
                if (Cari(DL, huruf))
                    cout << "Simpul " << huruf << " ditemukan." << endl;
                else
                    cout << "Simpul " << huruf << " tidak ditemukan." << endl;
                cout << endl;
                break;
            case 9:
                ...
                break;
            default:
                cout << "\nInput tidak valid. Silakan pilih menu 1-9.\n";
                break;
        }
...
void Hapus_Tengah(simpul &DL, char elemen) {
    ...
    if (DL == NULL)
        ...
        bantu = DL;
        while (bantu->Isi != elemen && bantu != NULL)
            bantu = bantu->kanan;
        if (bantu != NULL) {
            hapus = bantu;
            if (bantu->kiri != NULL)
...
// Implementasi fungsi pencarian simpul
bool Cari(simpul DL, char elemen) {
    simpul bantu;
    bantu = DL;
    while (bantu != NULL) {
